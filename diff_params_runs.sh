...
python main.py -lr 0.5 -bs 50 -niter 20000 -ws 5 -vs 75 -ns 10 -lrd 20000 -alpha 0.01 -vi 400
python main.py -lr 0.1 -bs 50 -niter 20000 -ws 5 -vs 75 -ns 10 -lrd 20000 -alpha 0.01 -vi 400
